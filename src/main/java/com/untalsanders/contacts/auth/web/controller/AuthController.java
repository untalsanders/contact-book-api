package com.untalsanders.contacts.auth.web.controller;
...
import com.untalsanders.contacts.auth.web.dto.RegisterUserRequest;
import com.untalsanders.contacts.auth.application.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<RegisterUseCase.RegisterResult>> register(@Valid @RequestBody RegisterUserRequest request) {
        ...
        ApiResponse<RegisterUseCase.RegisterResult> body = ApiResponse.success(HttpStatus.CREATED.value(), result, "User registered successfully");
    ...
    public ResponseEntity<ApiResponse<AuthResponse>> login(@Valid @RequestBody LoginRequest request) {
        ...
        ApiResponse<AuthResponse> body = ApiResponse.success(HttpStatus.OK.value(), response, "User logged in successfully");
